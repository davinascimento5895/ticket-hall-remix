...
import { ArrowRight, Chrome, Eye, EyeOff, Loader2, Lock, Mail, X } from "lucide-react";
...
<form
            ...
            >
              ...
              >
                {loading ? (
                  <>
                    ...
                    {view === "login" ? "Entrando..." : "Criando conta e continuando..."}
                  </>
                ) : (
                  <>
              ...
              <Button
                ...
                className={`w-full border-border ${isUltraCompact ? "h-10 text-sm" : "h-11"} ${loading ? "opacity-70 pointer-events-none" : ""}`}
              >
