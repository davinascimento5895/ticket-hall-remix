  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_today:
          "ring-2 ring-primary/60 ring-inset text-primary font-semibold bg-transparent",
        day_outside:
