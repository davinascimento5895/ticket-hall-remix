        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link to="/blog" className="hover:text-foreground transition-colors">Perguntas Frequentes</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-4">
              <a href="https://instagram.com/tickethall" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors" aria-label="Instagram">
              ...
              <a href="https://linkedin.com/company/tickethall" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors" aria-label="LinkedIn">
