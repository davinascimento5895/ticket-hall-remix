...
export default function InterestLists() {
  return (
    <>
      <SEOHead title="Funcionalidades — Listas de interesse" description="Colete inscrições e leads de interessados antes do evento." />
      ...
      <div className="container pt-24 pb-16">
        <nav className="text-sm mb-3">
          ...
          <span className="px-2 text-muted-foreground">›</span>
          <Link to="/produtores/funcionalidades/interest-lists" className="font-bold">Listas de interesse</Link>
        </nav>
        <h1 className="font-display text-3xl md:text-4xl font-bold mb-2">Listas de interesse</h1>
        <p className="text-muted-foreground max-w-2xl mb-6">Colete e gerencie leads de interessados para campanhas futuras e pré-venda.</p>

        <section className="space-y-6">
          <div>
            <h3 className="font-semibold">Funcionalidades</h3>
            <ul className="list-disc pl-5 text-muted-foreground mt-2">
              <li>Formulários de interesse integráveis</li>
              <li>Exportação CSV e integração com ferramentas de e-mail</li>
              <li>Segmentação por evento ou categoria</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc pl-5 text-muted-foreground mt-2">
              <li>Construir audiências para pré-venda</li>
              <li>Campanhas de retenção e remarketing</li>
            </ul>
          </div>
