...
const changelog: ChangelogEntry[] = [
  {
    ...
    highlights: [
      "Plataforma completa de venda de ingressos online com a menor taxa do Brasil: 7%",
      "Painel do produtor com dashboard, relatórios e gestão completa de eventos",
      "Check-in por QR Code com modo offline e sincronização automática",
      "Fila virtual com admissão em lotes e expiração de sessão configurável",
    ],
    features: [
      "Certificados de participação gerados automaticamente para ingressos utilizados",
      "Suporte a eventos multi-day com datas válidas por lote",
      "Seguro de ingresso opcional no checkout com preço dinâmico",
      "Meia-entrada com campos de documento (estudante, PcD, idoso) integrados ao checkout",
      "Landing pages otimizadas para compradores e produtores com animações de scroll",
      "Página de changelog para acompanhar a evolução da plataforma",
    ],
    fixes: [
