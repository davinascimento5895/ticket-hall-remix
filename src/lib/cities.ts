...
export const BRAZILIAN_CAPITALS: BrazilianCapital[] = [
  { name: "São Paulo", state: "São Paulo", uf: "SP", population: 12_400_000, imageUrl: "/images/cities/sao-paulo.jpg", featured: true },
  ...
  { name: "Salvador", state: "Bahia", uf: "BA", population: 2_900_000, imageUrl: "/images/cities/salvador.png", featured: true },
  ...
  { name: "São Luís", state: "Maranhão", uf: "MA", population: 1_110_000, imageUrl: "/images/cities/sao-luis.jpg", featured: false },
  { name: "Maceió", state: "Alagoas", uf: "AL", population: 1_030_000, imageUrl: "/images/cities/maceio.jpg", featured: false },
  ...
  { name: "Teresina", state: "Piauí", uf: "PI", population: 870_000, imageUrl: "/images/cities/teresina.jpg", featured: false },
  { name: "João Pessoa", state: "Paraíba", uf: "PB", population: 830_000, imageUrl: "/images/cities/joao-pessoa.jpg", featured: false },
  { name: "Natal", state: "Rio Grande do Norte", uf: "RN", population: 810_000, imageUrl: "/images/cities/natal.jpg", featured: false },
  ...
  { name: "Vitória", state: "Espírito Santo", uf: "ES", population: 370_000, imageUrl: "/images/cities/vitoria.jpg", featured: false },
